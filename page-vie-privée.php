...
<div class="mentions-rgpd">
    ...
    <h2>Vie privée</h2>
    <h3>Who we are
        <p>Suggested text: Our website address is: http://nathalie-mota.local.</p>
    </h3>
    
    <h3>Comments
        <p>
            Suggested text: When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP address and browser user agent string to help spam detection.<br><br>
    ...
    <h3>Embedded content from other websites
        <p>
    ...
    <h3>How long we retain your data
        <p>
    ...
    <h3>What rights you have over your data
        <p>
